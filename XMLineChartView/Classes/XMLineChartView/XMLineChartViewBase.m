...
@interface XMLineChartViewBase()


@end

@implementation XMLineChartViewBase
              ...
              lineWidth:(CGFloat)lineWidth
{
    ...
    if ([value isKindOfClass:[XMTimeLineEntity class]]) {
        XMTimeLineEntity * entity = value;
        leftMarkerStr = [self handleStrWithPrice:entity.lastPirce];
        bottomMarkerStr = entity.currtTime;
        rightMarkerStr = entity.rate;
        
    }else if([value isKindOfClass:[XMLineEntity class]]){
        XMLineEntity * entity = value;
